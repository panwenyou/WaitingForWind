...
bool MainGameMenu::init()
{
	...
	auto back_item = MenuItemImage::create("Back.png", "Back.png", "Back.png", CC_CALLBACK_1(MainGameMenu::onBackItem,this));
	auto replay_item = MenuItemImage::create("Replay.png", "Replay.png", "Replay.png", CC_CALLBACK_1(MainGameMenu::onReplayItem,this));
